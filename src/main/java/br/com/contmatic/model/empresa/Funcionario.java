...
public class Funcionario {
    ...
    @Pattern(regexp = Regex.SOMENTE_LETRAS, message = "Caractere invalido no nome do funcionario")
    private String nome;
    ...
    @Pattern(regexp = Regex.LETRAS_PARENTESES, message = "Caractere invalido em cargo")
    ...
    public void setTelefones(Set<Telefone> telefones) {
        Preconditions.checkArgument(telefones.size() < 2, "Somente é permitido um telefone");
