...
public class FuncionarioTest {
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com salario igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com salario diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com cargo igual do enviado no set.
     */
    @Test
    public void deve_retornar_verdadeiro_na_comparacao_do_get_com_cargo_igual_do_enviado_no_set() {
        assertThat(funcionario.getCargo(), either(containsString("Vendedor")).or(containsString("Gerente")).or(containsString("Caixa")));
    }

    /**
     * Deve retornar falso na comparacao do get com cargo diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com cpf igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com nascimento igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com nascimento diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com contratacao igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com contratacao diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com telefone igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com telefone diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com endereco igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com endereco diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso quando comparado funcionario a um objeto nulo atraves do equals.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro se no to string contem o nome do funcionario.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_o_nome_do_funcionario() {
        assertThat(funcionario.toString(), containsString("nome"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem o cpf do funcionario.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_o_cpf_do_funcionario() {
        assertThat(funcionario.toString(), containsString("cpf"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem o cargo do funcionario.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_o_cargo_do_funcionario() {
        assertThat(funcionario.toString(), containsString("cargo"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem o salario do funcionario.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_o_salario_do_funcionario() {
        assertThat(funcionario.toString(), containsString("salario"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem a data de contratacao do funcionario.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_a_data_de_contratacao_do_funcionario() {
        assertThat(funcionario.toString(), containsString("contratacao"));
    }

    /**
     * Deve retornar uma exception quando endereco for nulo.
     */
    @Test(expected = NullPointerException.class)
    public void deve_retornar_uma_exception_quando_endereco_for_nulo() {
        funcionario.setEnderecos(null);
    }

    /**
     * Deve retornar uma exception quando for inserido mais de um endereco.
     */
    @Test(expected = IllegalArgumentException.class)
    public void deve_retornar_uma_exception_quando_for_inserido_mais_de_um_endereco() {
        Set<Endereco> endereco = new HashSet<>();
        endereco.add(Fixture.from(Endereco.class).gimme("valid"));
        endereco.add(Fixture.from(Endereco.class).gimme("valid"));
        endereco.add(Fixture.from(Endereco.class).gimme("valid"));
    ...
    /**
     * Deve retornar uma exception quando telefone for nulo.
     */
    @Test(expected = NullPointerException.class)
    public void deve_retornar_uma_exception_quando_telefone_for_nulo() {
        funcionario.setTelefones(null);
    }

    /**
     * Deve retornar uma exception quando for inserido mais de um telefone.
     */
    @Test(expected = IllegalArgumentException.class)
    public void deve_retornar_uma_exception_quando_for_inserido_mais_de_um_telefone() {
        Set<Telefone> telefone = new HashSet<>();
        telefone.add(Fixture.from(Telefone.class).gimme("valid"));
        telefone.add(Fixture.from(Telefone.class).gimme("valid"));
        telefone.add(Fixture.from(Telefone.class).gimme("valid"));
    ...
    public void deve_retornar_verdadeiro_na_captura_de_erro_quando_tiver_numero_no_nome() {
        ...
        Set<ConstraintViolation<Funcionario>> constraintViolations = validator.validate(funcionario);
        assertEquals(1, constraintViolations.size());
        assertEquals("Caractere invalido no nome do funcionario", constraintViolations.iterator().next().getMessage());
    }

    /**
     * Deve retornar verdadeiro na captura de erro quando salario for menor que o permitido.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na captura de erro quando salario for maior que o permitido.
     */
    @Test
    ...
    public void deve_retornar_verdadeiro_na_captura_de_erro_quando_tiver_numero_no_cargo() {
        ...
        Set<ConstraintViolation<Funcionario>> constraintViolations = validator.validate(funcionario);
        assertEquals(1, constraintViolations.size());
        assertEquals("Caractere invalido em cargo", constraintViolations.iterator().next().getMessage());
    }
    ...
    /**
     * Deve retornar verdadeiro na captura de erro quando cpf for maior que o permitido.
     */
    @Test
    public void deve_retornar_verdadeiro_na_captura_de_erro_quando_cpf_for_maior_que_o_permitido() {
        funcionario.setCpf("123456789123456789123");
        Set<ConstraintViolation<Funcionario>> constraintViolations = validator.validate(funcionario);
        assertEquals(1, constraintViolations.size());
        assertEquals("CPF inválido", constraintViolations.iterator().next().getMessage());
    }
