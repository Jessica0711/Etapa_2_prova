...
public class EmpresaTest {
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com cnpj igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com cnpj diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com site igual do enviado no set.
     */
    @Test
    public void deve_retornar_verdadeiro_na_comparacao_do_get_com_site_igual_do_enviado_no_set() {
        assertThat(empresa.getSite(), either(containsString("http://teste.com.br")).or(containsString("http://empresa.com.br")));
    }

    /**
     * Deve retornar falso na comparacao do get com site diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com funcionario igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com funcionario diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar verdadeiro na comparacao do get com produto igual do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso na comparacao do get com produto diferente do enviado no set.
     */
    @Test
    ...
    /**
     * Deve retornar falso quando comparado empresa a um objeto nulo atraves do equals.
     */
    @Test
    ...
    /**
     * Deve retornar uma exception para set de endereco com mais de um elemento.
     */
    @Test(expected = IllegalArgumentException.class)
    public void deve_retornar_uma_exception_para_set_de_endereco_com_mais_de_um_elemento() {
        Set<Endereco> endereco = new HashSet<>();
        endereco.add(Fixture.from(Endereco.class).gimme("valid"));
        endereco.add(Fixture.from(Endereco.class).gimme("valid"));
        empresa.setEnderecos(endereco);
    ...
    /**
     * Deve retornar uma exception para telefone nulo.
     */
    @Test(expected = NullPointerException.class)
    public void deve_retornar_uma_exception_para_telefone_nulo() {
        empresa.setTelefones(null);
    }

    /**
     * Deve retornar uma exception para set de telefone com mais de um elemento.
     */
    @Test(expected = IllegalArgumentException.class)
    public void deve_retornar_uma_exception_para_set_de_telefone_com_mais_de_um_elemento() {
        Set<Telefone> telefone = new HashSet<>();
        telefone.add(Fixture.from(Telefone.class).gimme("valid"));
        telefone.add(Fixture.from(Telefone.class).gimme("valid"));
        telefone.add(Fixture.from(Telefone.class).gimme("valid"));
    ...
    /**
     * Deve retornar verdadeiro se no to string contem nome da empresa.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_nome_da_empresa() {
        assertThat(empresa.toString(), containsString("nome"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem cnpj.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_cnpj() {
        assertThat(empresa.toString(), containsString("cnpj"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem endereco.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_endereco() {
        assertThat(empresa.toString(), containsString("endereco"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem funcionarios.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_funcionarios() {
        assertThat(empresa.toString(), containsString("funcionarios"));
    }

    /**
     * Deve retornar verdadeiro se no to string contem produtos.
     */
    @Test
    public void deve_retornar_verdadeiro_se_no_toString_contem_produtos() {
    ...
    public void deve_retornar_verdadeiro_na_captura_de_erro_quando_funcionarios_e_nulo() {
        ...
        assertEquals("Funcionarios não pode ser vazio", constraintViolations.iterator().next().getMessage());
    }
    ...
    public void deve_retornar_verdadeiro_na_captura_de_erro_quando_nome_for_maior_que_o_limite() {
        empresa.setNome("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
        Set<ConstraintViolation<Empresa>> constraintViolations = validator.validate(empresa);
        assertEquals(1, constraintViolations.size());
        assertEquals("nome com tamanho invalido", constraintViolations.iterator().next().getMessage());
    }
    ...
    /**
     * Deve retornar verdadeiro na captura de erros quando o site nao estiver na formatacao correta.
     */
    @Test
    public void deve_retornar_verdadeiro_na_captura_de_erros_quando_o_site_nao_estiver_na_formatacao_correta() {
        ...
        Set<ConstraintViolation<Empresa>> constraintViolations = validator.validate(empresa);
        assertEquals(1, constraintViolations.size());
        assertEquals("Deve ser uma URL válida", constraintViolations.iterator().next().getMessage());
    }
    ...
    /**
     * Should return true to correct output of tostring.
     */
    @Test
    @Ignore
